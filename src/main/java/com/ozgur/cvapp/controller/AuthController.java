...
import com.ozgur.cvapp.payload.request.LoginRequest;
import com.ozgur.cvapp.payload.request.SignupRequest;
import com.ozgur.cvapp.payload.response.MessageResponse;
import com.ozgur.cvapp.payload.response.UserInfoResponse;
import com.ozgur.cvapp.security.jwt.JwtUtils;
import com.ozgur.cvapp.repository.RoleRepository;
...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    User user = User.builder()
            ...
            .KVKK(signUpRequest.getKVKK())
            .CVLink(signUpRequest.getCVLink())
            .build();
